...
upgraded to run under Django 5.2.x, where x is the latest security update. It
should run comfortably under all versions of Django from 2.0 to 5.2.x It is no
longer compatible with Django < 2.0. The recommended Django is now 5.2.x
